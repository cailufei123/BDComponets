...
+ (void)gtSDK_updatemakeConstraints141WithView:(UIView * _Nonnull)view view2:(UIView * _Nonnull)view2 view3:(UIView * _Nonnull)view3;
...
SWIFT_CLASS("_TtC9CoinTools21HWCompareProgressView")
@interface HWCompareProgressView : UIView
